"""
AWS Glue ETL job for processing and analyzing flight delay data.

This script performs the following operations:
1. Extracts flight data and airport dimension data from Redshift
2. Filters for flights with departure delays exceeding 60 minutes
3. Enriches the flight data with departure and arrival airport details
4. Transforms and loads the processed data into a fact table in Redshift for analysis

The output provides insights into delayed flights along with their associated airport information, enabling analysis of delay patterns across different carriers and routes.
"""
